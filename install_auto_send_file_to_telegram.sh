...
После установки рекомендую для удобства управления скриптом поставить веб интерфейс luci-app-auto_send_file_to_telegram"
